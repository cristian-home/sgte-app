...
return [
    ...
    */
    'generators' => [
        ...
        'notification' => \App\Blueprint\Generators\Statements\CustomNotificationGenerator::class,
        'resource' => \Blueprint\Generators\Statements\ResourceGenerator::class,
        'view' => \Blueprint\Generators\Statements\ViewGenerator::class,
        'inertia_page' => \App\Blueprint\Generators\CustomInertiaPageGenerator::class,
