...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // SGTE backups are database-only — no application files are
                    // bundled (the codebase lives in Git). `backup:run` is also
                    // scheduled with --only-db for explicitness.
                ],
    ...
    'notifications' => [
        'notifications' => [
            // Only failures and unhealthy-backup alerts are mailed. Success
            // notifications are silenced so a daily "all good" email does not
            // train the team to ignore backup mail.
