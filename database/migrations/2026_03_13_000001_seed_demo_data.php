...
use Database\Seeders\DayStatusSeeder;
use Database\Seeders\FuecSeeder;
use Database\Seeders\ServiceIncidentSeeder;
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        (new \Database\Seeders\DriverSeeder)->run();
        (new VehicleSeeder)->run();
        (new \Database\Seeders\ContractSeeder)->run();
        (new \Database\Seeders\InvoiceSeeder)->run();
        (new DayStatusSeeder)->run();
        $this->seedServices();
        (new ServiceIncidentSeeder)->run();
        (new FuecSeeder)->run();
        (new VehicleLocationSeeder)->run();
    }

    public function down(): void
    {
        // Demo data should not be rolled back.
    }
