...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Third-Parties Index',
        href: thirdParties.index().url,
    },
];
...
export default function ThirdPartiesIndex({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Third-Parties Index" />
