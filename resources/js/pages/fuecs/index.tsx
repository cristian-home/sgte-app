...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Fuecs Index',
        href: fuecs.index().url,
    },
];

export default function FuecsIndex({ fuecs }: { fuecs: unknown }) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Fuecs Index" />
