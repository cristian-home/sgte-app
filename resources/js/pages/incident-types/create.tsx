...
import incidentTypes from '@/routes/incident-types';
import type { BreadcrumbItem } from '@/types';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Tipos de Novedad', href: IncidentTypeController.index.url() },
    { title: 'Crear', href: incidentTypes.create().url },
];

export default function IncidentTypesCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Crear Tipo de Novedad" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Card>
                    <CardHeader>
                        <CardTitle>Crear Tipo de Novedad</CardTitle>
                    </CardHeader>
                    <CardContent>
