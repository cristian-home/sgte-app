...
import severanceFunds from '@/routes/severance-funds';
import { type BreadcrumbItem } from '@/types';

// TODO: Replace with your actual breadcrumb setup
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Severance-Funds Show',
        href: severanceFunds.show().url,
    },
];
...
export default function SeveranceFundsShow({
    ...
    severanceFund: unknown;
}) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Severance-Funds Show" />
