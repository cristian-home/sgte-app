                            ...
                            {!manualSetupKey ? (
                                ...
                                <>
                                    <input
                                        ...
                                        className="h-full w-full bg-background p-3 font-mono text-sm tracking-wider text-foreground outline-none select-all"
                                    />
                                    <button
    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación de dos factores está habilitada. Escanee el código QR o ingrese la clave de configuración en su aplicación de autenticación.',
                buttonText: 'Cerrar',
            };
        }
